@echo off
rem ============================================================
rem  FitDeveloper firewall fix - adds inbound rules for the
...
echo Adding firewall rules for FitDeveloper...
netsh advfirewall firewall delete rule name="FitDeveloper HTTP"  >nul 2>&1
netsh advfirewall firewall delete rule name="FitDeveloper HTTPS" >nul 2>&1
